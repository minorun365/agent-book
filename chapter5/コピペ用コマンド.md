...
```
# 依存ライブラリをインストール
npm install @mastra/libsql@0.13.7 @mastra/memory@0.14.2 @mastra/loggers@0.10.9 @mastra/core@0.15.2 zod@3
...
# Next.jsの初期化を実施
npx create-next-app@15.3.6 /workspaces/mastra_practice
```
...
npm install mastra@0.11.3 @mastra/core@0.15.2 @mastra/libsql@0.13.7 @mastra/memory@0.14.2 @mastra/loggers@0.10.9 @ai-sdk/amazon-bedrock@3.0.13 zod@3
...
```
cd /workspaces/mastra_practice
npm install aws-amplify@6.15.5 @aws-amplify/ui-react@6.12.0 @aws-amplify/adapter-nextjs@1.6.8 aws-cdk-lib@2.204.0 @aws-sdk/credential-providers@3.876.0
```
